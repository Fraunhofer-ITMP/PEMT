...
from src.constants import MAPPER_DIR, PATENT_DIR
from src.utils import get_chemical_names
...
def harmonize_chemicals(
    ...
    if os.path.exists(f'{MAPPER_DIR}/chemical_names.json'):
        chemical_names = json.load(open(f'{MAPPER_DIR}/chemical_names.json'))
    else:
